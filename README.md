# Speech Emotion Classification in Audio

This repository has two main directories:

* `full`: contains the full data, features, and spectrograms used for training
* `subsetted`: contains a subset of the data for testing

*Before following the below instructions, `cd` to one of those directories.*
